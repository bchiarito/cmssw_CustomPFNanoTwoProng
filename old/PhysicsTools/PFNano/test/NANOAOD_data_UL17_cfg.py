...
# with command line options: nanoaod -s NANO --nThreads 1 --data --era Run2_2017,run2_nanoAOD_106Xv1 --conditions 106X_dataRun2_v32 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False))) --filein file:output_numEvent100.root -n 100 --python_filename=nano_Run2017.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring
