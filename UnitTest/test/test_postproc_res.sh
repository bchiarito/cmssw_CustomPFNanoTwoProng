...
python ../../PhysicsTools/NanoAODTools/scripts/nano_postproc.py . NanoAOD.root -I PhysicsTools.NanoAODTools.postprocessing.modules.main genpartConstr_res,filtersConstr_default,twoprongConstr_addLoose,photonConstr_default,recoPhiConstr_HPID,recoPhiConstr_cutBased,selectionConstr_default --bo ../../PhysicsTools/NanoAODTools/test/dropPF.txt
